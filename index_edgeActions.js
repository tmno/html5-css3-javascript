...
//Edge binding end
Symbol.bindElementAction(compId,symbolName,"${_pintr}","click",function(sym,e){window.open("http://pinterest.com/tomnora/","_self");});
//Edge binding end
Symbol.bindElementAction(compId,symbolName,"${_behanc-100}","click",function(sym,e){window.open("http://be.net/norart","_self");});
//Edge binding end
})("stage");
